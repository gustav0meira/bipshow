	...
	<div class="container events">
		...
		<div class="row dropEvents">
			<div class="col-11 col-md-4 col-lg-3 mx-auto">
				<div onclick="window.location.href='<?php echo route('evento') ?>?id=nomedoeventodeteste'" class="moduleEvent">
					<div class="photo">
					...
					<div style="padding: 0px 8px;" class="row">
						<div class="col-9">
							<label class="title">Talent Show</label><br>
							<label class="city">Florianópolis, SC</label><br>
							<label class="local">Teatro Carlos Gomes</label><br>
							<button class="buy">
						...
						<div style="text-align: right;" class="col-3">
							<center>
								<label class="month">JUL</label><br>
								<label class="day">18</label><br>
								<label class="hour">22:00</label>
							</center>
						</div>
					</div>
				</div>
